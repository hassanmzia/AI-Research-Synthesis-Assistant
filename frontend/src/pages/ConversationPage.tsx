...
export default function ConversationPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Header */}
      <div className="px-6 py-4 border-b border-gray-200 dark:border-dark-border bg-white dark:bg-dark-surface">
      ...
      {/* Input */}
      <div className="px-6 py-4 border-t border-gray-200 dark:border-dark-border bg-white dark:bg-dark-surface">
